...
const servicesDataButtom = [
  {
    ...
    text_two: "Nulla mattis lacus pharetra aliquet porttitor.",
    text_three:
      "Phasellus sodales ligula in odio facilisis, quis fermentum tellus dapibus.",
    text_four: "Mauris vel massa id lacus iaculis accumsan at in augue.",
    text_five: "Aenean convallis metus a ultricies pharetra.",
    descr_bottom:
