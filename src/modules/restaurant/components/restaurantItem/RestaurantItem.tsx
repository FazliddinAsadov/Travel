...
const mockdata = [
  { description: "Sun and sea", title: "Beach vacation", image: "" },
  { description: "Sightseeing", title: "City trips", image: "" },
  { description: "Mountains", title: "Hiking vacation", image: "" },
  {
...
export function ImageCheckboxes() {
  const items = mockdata.map((item) => (
    <ImageCheckboxes {...item} key={item.title} />
  ));
  return (
    <SimpleGrid
      cols={4}
